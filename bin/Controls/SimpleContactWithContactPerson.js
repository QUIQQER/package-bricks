 ...
 * @module Bricks\Controls\SimpleContactWithContactPerson
 */
define('package/quiqqer/bricks/bin/Controls/SimpleContactWithContactPerson', [
    ...
    return new Class({
        ...
        $onImport: function () {
            ...
            var Button = this.Form.getElement('.quiqqer-simpleContactPerson-button');
        ...
        send: function () {
            ...
            var PrivacyPolicyCheckbox = this.$Elm.getElement('#qui-simpleContactPerson-privacypolicy__standard');
